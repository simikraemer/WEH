...
function load_menu() {
    ...
    if ($_SESSION['valid']) {
        ...
        if ($_SESSION['Webmaster']) {
            ...
            echo '<button onclick="window.location.href=\'/Erstattung.php\';" style="white-space: nowrap;">Kostenerstattung</button>';
            ...
            echo '<button onclick="window.location.href=\'/Notaus.php\';" style="white-space: nowrap;">Notaus WEH</button>';
            echo '<button onclick="window.location.href=\'/Notaus_TvK.php\';" style="white-space: nowrap;">Notaus TvK</button>';
            echo '</div>';
            echo '</div>';
            echo '</div>';
        ...
        if ($_SESSION['turm'] === 'weh') {
            echo '<button onclick="window.location.href=\'https://www.weh.rwth-aachen.de/waschen\';" style="white-space: nowrap;">Waschsystem</button> ';
